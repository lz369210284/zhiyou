...
<body class="w100">
        ...
        <div class="container">
            ...
            <div id="profile_tab">
                <ul class="profile_tab_header f_left clearfix">
                    <li><a href="front/user/profile.action?method=get">更改资料</a></li>
                    <li class="profile_tab_line">|</li>
                    <li><a href="front/user/avatar.action?method=get">更改头像</a></li>
                    <li class="profile_tab_line">|</li>
                    <li><a href="front/user/password.action?method=get">密码安全</a></li>
                </ul>
                    ...
                    <div class="proflle_tab_workplace clearfix">
                        ...
                        <div class="profile_ifo_area">
                         ...
                         <c:if test="${not empty message}">
                            ...
                            <form id="check" action="front/user/password.action" method="post">
                                <div class="form_group">
                                    <span class="dd">旧&#x3000;密&#x3000;码：</span>
                                    <input onblur="checkPassword()" type="password" id="oldPassword" name="oldPassword">
                                </div>
                                <div class="form_group">
   ...
   function checkPassword(){
	   $.post('front/user/queryPassword.action',$('#check').serialize(),function(result){
			console.log(result);
			if(result=="success"){
