...
<body>
    ...
    <main>
        <div class="container">
            <form id="setPwd" class="ma" action="front/admin/forgetpwd.action" method="post" >
...
<%@include file="../include/script.html"%>
    <script type="text/javascript">
		function submitEmail(){
			...
			//改为ajax提交邮箱
			if(email!=null&&email!=''){
				$.post('front/admin/sendemail.action',{email:email},function(data){
					console.log(data);
					if(data=="success"){
		...
		$('#setPwd').validate({
			submitHandler:function(form){
				console.log($('#setPwd').serialize());
				//使用ajax的post方法提交修改密码的验证信息
				$.post('front/admin/changePwd.action',$('#setPwd').serialize(),function(result){
					console.log(result);
					if(result=="success"){
						//登录成功,刷新页面
						form.submit();
